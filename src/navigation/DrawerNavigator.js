  ...
  return (
    ...
    screenOptions={{
      ...
      drawerLabelStyle: {
        ...
        <Drawer.Screen name="menu" component={ProductsScreen} />
        <Drawer.Screen name="CHARGER DE FONTS" component={CommandeScreen} />
        ...
        <Drawer.Screen name="MON RESEAUX" component={HomeScreen} />
